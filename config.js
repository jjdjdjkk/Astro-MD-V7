...
FOOTER: process.env.FOOTER === undefined ? 'Zeeshan-Ansari ᴘᴜʙʟɪᴄ ꜱᴛᴀʙʟᴇ' : process.env.FOOTER,
CAPTION: process.env.CAPTION === undefined ? '*ɢᴇɴᴀʀᴀᴛᴇᴅ ʙʏ Zeeshan-ᴍᴅ*' : process.env.CAPTION,
...
SESSION_ID: process.env.SESSION_ID === undefined ? 'ASTRO=IjggBYyY#LoHOavlAsNegEugdsMK260kJ5JucO8rGjW2XXX4dpa4' : process.env.SESSION_ID
};
